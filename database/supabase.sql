...
-- Crie o administrador inserindo o UUID do usuário autenticado em public.admin_users.
-- Exemplo: insert into public.admin_users (user_id) values ('UUID-DO-USUARIO');
